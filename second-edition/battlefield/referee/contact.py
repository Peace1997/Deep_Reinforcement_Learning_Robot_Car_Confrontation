...
class ContactListener(contactListener):
    ...
    def PreSolve(self, contact, oldManifold):
        ...
        if u1_type == "bullet" and u2_type == "sensor":
            self.collision_bullet_sensor.append((u1, u2))
        elif u2_type == "bullet" and u1_type == "sensor":
            self.collision_bullet_sensor.append((u2, u1))
